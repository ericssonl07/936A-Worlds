...
// Left side motors
vex::motor       left_motor1(vex::PORT8, vex::ratio6_1, true);
vex::motor       left_motor2(vex::PORT9, vex::ratio6_1, true);
vex::motor       left_motor3(vex::PORT7, vex::ratio6_1, false);
...
vex::pneumatics  hang_piston(brain.ThreeWirePort.C);
